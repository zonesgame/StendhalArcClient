...
public class Fx implements ContentList{
    ...
    none, /** 放置块效果*/placeBlock, /** 拆除块效果*/breakBlock, smoke, /** 重生效果*/spawn, tapBlock, select,
    ...
    /** 单位工厂生产效果*/producesmoke, smeltsmoke, formsmoke, blastsmoke, lava, doorclose, dooropen, dooropenlarge, doorcloselarge, purify, purifyoil, purifystone, generate,
