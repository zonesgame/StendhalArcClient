...
public class NetClient implements ApplicationListener{
    ...
    private static boolean temp_start = false;
    private static final boolean debug = true;
    private static boolean showWorld = false;
    private static marauroa.client.ClientFramework clientManager;
    private static PerceptionHandler handler;
    private static Map<RPObject.ID, RPObject> world_objects;
    public static void temp_connect() {
        if (temp_start) return;
        temp_start = true;
