...
public class DeployDialog extends FloatingDialog{
    ...
    public DeployDialog(){
        ...
        treeLayout();
        Events.on(ContentReloadEvent.class, e -> treeLayout());     // 接收处理ContentReloadEvent

        addCloseButton();       // 添加关闭按钮
        buttons.addImageTextButton("$techtree", Icon.tree, () -> ui.tech.show()).size(230f, 64f);       // 添加科技树按钮
