        ...
        alpha = new Mech("alpha-mech", false){
            {
                ...
                mineSpeed = 1.5f;
                mass = 1.2f;
                speed = enable_isoInput ? 0.5f / tilesize : 0.5f;
                itemCapacity = 40;
                boostSpeed = enable_isoInput ? 0.95f / tilesize : 0.95f;
                buildPower = 1.2f;
                ...
                weapon = new Weapon("blaster"){{
                    ...
                    bullet = Bullets.standardMechSmall;         // default    standardMechSmall
                }};
            }
        ...
        glaive = new Mech("glaive-ship", true){
            {
                drillPower = 4;
                mineSpeed = 1.3f;
                speed = enable_isoInput ? 0.32f / tilesize : 0.32f;
                drag = 0.06f;
                mass = 3f;
                health = 240f;
                itemCapacity = 60;
...
//        alpha = new Mech("alpha-mech", false){            // default
//            {
//                drillPower = 1;
//                mineSpeed = 1.5f;
//                mass = 1.2f;
        ...
        dart = new Mech("dart-ship", true){
            {
                ...
                weapon = new Weapon("blaster"){{
                    ...
                    alternate = true;
                    ejectEffect = Fx.shellEjectSmall;
                    bullet = Bullets.lancerLaser;            //  default   standardCopper
                }};
            }
