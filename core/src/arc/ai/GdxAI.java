...
public final class GdxAI {
	...
	private static Logger logger = Core.app == null ? new NullLogger() : new GdxLogger();
	private static FileSystem fileSystem = Core.files == null ? new StandaloneFileSystem() : new GdxFileSystem();
