...
public class Floor extends Block{
    /** 纹理变体数量.<p/>number of different variant regions to use */
    public int variants = 3;
    /** 边界名称.<p/>edge fallback, used mainly for ores */
    public String edge = "stone";
    /** 单位速度倍数.<p/>Multiplies unit velocity by this when walked on. */
    public float speedMultiplier = 1f;
    /** 单位阻力倍数.<p/>Multiplies unit drag by this when walked on. */
    public float dragMultiplier = 1f;
    /** 块上承受伤害.<p/>Damage taken per tick on this tile. */
    public float damageTaken = 0f;
    /** 溺亡时间.<p/>How many ticks it takes to drown on this. */
    public float drownTime = 0f;
    /** 行走效果.<p/>Effect when walking on this floor. */
    public Effect walkEffect = Fx.ripple;
    /** 溺亡更新效果.<p/>Effect displayed when drowning on this floor. */
    public Effect drownUpdateEffect = Fx.bubble;
    /** 单位行走时接收效果.<p/>Status effect applied when walking on. */
    public StatusEffect status = StatusEffects.none;
    /** 应用状态强度.<p/>Intensity of applied status effect. */
    public float statusDuration = 60f;
    /** 倾泻流体.<p/>liquids that drop from this block, used for pumps */
    public Liquid liquidDrop = null;
    /** 倾泻物品.<p/>item that drops from this block, used for drills */
    public Item itemDrop = null;
    /** 是否可淹死单位.<p/>whether this block can be drowned in */
    public boolean isLiquid;
    /** 如果为ture玩家不可开采. 如屏蔽沙子等物品.<p/>if true, this block cannot be mined by players. useful for annoying things like sand. */
    public boolean playerUnmineable = false;
    /** 边块群.<p/>Group of blocks that this block does not draw edges on. */
    public Block blendGroup = this;
    /** 随机更新效果.<p/>Effect displayed when randomly updated. */
    public Effect updateEffect = Fx.none;
    /** 属性数据.<p/>Array of affinities to certain things. */
    public Attributes attributes = new Attributes();
    /** 该矿石是否在默认情况下生成地图.<p/>Whether this ore generates in maps by default. */
    public boolean oreDefault = false;
    /** 矿石构建属性.<p/>Ore generation params. */
