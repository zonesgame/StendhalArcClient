...
public class UnitTypes implements ContentList{
    ...
    public static UnitType
            ...
            /** 尖刀*/dagger, crawler, titan, fortress, eruptor, chaosArray, eradicator,
    // zones add begon
    /** 三国测试单位*/ testUnitSG,
    marketWorker,     // 使用单位
    /** 弓箭兵*/testUnit,
    /** 刀盾兵*/testUnit2, /** 刀盾测试单位*/testUnit3, /** 应用单位测试*/testGroundUse,
    /** 物品运输单位*/
    worker
    // zones add end
            ;
    ...
    public void load(){
        ...
        testUnitSG = new UnitType("testUnitSG", SGSpriteUnit::new){{
            maxVelocity = 1.1f;
            speed = 0.2f;
            drag = 0.4f;
            hitsize = 8f;
            mass = 1.75f;
            health = 130;
            range = 150 * 1.5f;   // 单位检测范围
            weapon = new Weapon("chain-blaster"){{
                length = 1.5f * 1;
                reload = 28f * 1f;
                alternate = true;
                ejectEffect = null;
                bullet = Bullets.testBullet;    // zones add code
                shots = 1;
                disableAlternate = true;
                shotDelay = reload * 0.45f;
//                targetDistance = 8;
            }};
        }};

        // 市场获取货物工人
        marketWorker = new UnitType("marketWorker", BlockUnit::new, "debug/xml/unitTypes/market.xml"){{
            maxVelocity = 1.1f / tilesize;
            speed = 0.2f / tilesize;
            drag = 0.4f;
            hitsize = 8f;
            mass = 1.75f;
            health = 130;
            range = 50 * 1.0f;   // 单位检测范围
        ...
        // zones add begon
        testUnit = new UnitType("testUnit", SpriteUnit::new, "debug/xml/unitTypes/testUnit.xml"){{  // 远程单位测试
            maxVelocity = enable_isoInput ? 1.1f / tilesize : 1.1f;
            speed = enable_isoInput ? 0.2f / tilesize : 0.2f;
            drag = 0.4f;
            hitsize = enable_isoInput ? 8f / tilesize : 8f;
            mass = 1.75f;
            health = 130;
            weapon = new Weapon("chain-blaster"){{
                length = 1.5f;
        ...
        testUnit2 = new UnitType("testUnit2", SpriteUnit::new, "debug/xml/unitTypes/testUnit2.xml"){{  // 远程单位测试
            maxVelocity = enable_isoInput ? 1.1f / tilesize : 1.1f;
            speed = enable_isoInput ? 0.2f / tilesize : 0.2f;
            drag = 0.4f;
            hitsize = enable_isoInput ? 8f / tilesize : 8f;
            ...
            weapon = new Weapon("chain-blaster"){{
                ...
                alternate = true;
                ejectEffect = Fx.shellEjectSmall;
                bullet = Bullets.melee1;
            }};
        }};

//        testUnit2 = new UnitType("testUnit2", SpriteUnit::new, "debug/xml/unitTypes/testUnit2.xml"){{
//            maxVelocity = 1.1f;
//            speed = 0.2f;
//            drag = 0.4f;
//            hitsize = 8f;
...
//        }};
        ...
        testUnit3 = new UnitType("testUnit3", SpriteUnit::new, "debug/xml/unitTypes/testUnit3.xml"){{     // 近战单位测试
            maxVelocity = enable_isoInput ? 1.1f / tilesize : 1.1f;
            speed = enable_isoInput ? 0.2f / tilesize : 0.2f;
            drag = 0.4f;
            hitsize = enable_isoInput ? 8f / tilesize : 8f;
        ...
        testGroundUse = new UnitType("useGround", MachineUnit::new, "debug/xml/unitTypes/testUnit3.xml"){{     // 近战单位测试
            maxVelocity = enable_isoInput ? 1.1f / tilesize : 1.1f;
            speed = enable_isoInput ? 0.2f / tilesize : 0.2f;
            drag = 0.4f;
            hitsize = enable_isoInput ? 8f / tilesize : 8f;
        ...
        worker = new UnitType("worker", BlockUnit::new, "debug/xml/unitTypes/carts.xml"){{
            maxVelocity = 1.1f / tilesize;
            speed = 0.2f / tilesize;
            drag = 0.4f;
            hitsize = 8f;
