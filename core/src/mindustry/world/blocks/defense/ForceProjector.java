...
public class ForceProjector extends Block{
    ...
    public ForceProjector(String name){
        ...
        hasLiquids = true;
        hasItems = true;
        consumes[0].add(new ConsumeLiquidFilter(liquid -> liquid.temperature <= 0.5f && liquid.flammability < 0.1f, 0.1f)).boost().update(false);
    ...
    public void update(Tile tile){
        ...
        boolean phaseValid = consumes[tile.entity.level()].get(ConsumeType.item).valid(tile.entity);
        ...
        if(entity.buildup > 0){
            ...
            ConsumeLiquidFilter cons = consumes[tile.entity.level()].get(ConsumeType.liquid);
