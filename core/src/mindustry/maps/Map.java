...
import static z.debug.ZDebug.enable_defaultWave;

/**
 *  地图描述
 * */
public class Map implements Comparable<Map>, Publishable{
    /** 自定义地图.<p/>Whether this is a custom map. */
    public final boolean custom;
    /** 显示名称, 作者描述等.<p/>Metadata. Author description, display name, etc. */
    public final StringMap tags;
    /** 文件位置.<p/>Base file of this map. File can be named anything at all. */
    public final Fi file;
    /** 版本格式.<p/>Format version. */
    public final int version;
    /** steam地图.<p/>Whether this map is managed, e.g. downloaded from the Steam workshop.*/
    public boolean workshop;
    /** 地图尺寸.<p/>Map width/height, shorts. */
    public int width, height;
    /** 显示图片.<p/>Preview texture. */
    public Texture texture;
    /** 构建.<p/>Build that this map was created in. -1 = unknown or custom build. */
    public int build;
    /** 地图队伍.<p/>All teams present on this map.*/
    public IntSet teams = new IntSet();
    /** 敌人重生点数量.<p/>Number of enemy spawns on this map.*/
    public int spawns = 0;
    /** 关联mod.<p/>Associated mod. If null, no mod is associated. */
    ...
    public Rules rules(Rules base){
        try{
            ...
            if(result.spawns.isEmpty() || enable_defaultWave) result.spawns = Vars.defaultWaves.get();
            return result;
        }catch(Exception e){
