...
// relativeLocPosition.mul(orientationMatrix).add(anchor.position);
			if (relativeLocPosition instanceof Vec2)
				((Vec2)relativeLocPosition).mul(orientationMatrix);
			else if (relativeLocPosition instanceof Vec3) ((Vec3)relativeLocPosition).mul(orientationMatrix);
