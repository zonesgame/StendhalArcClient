...
public class Zones implements ContentList{
    /** 零号地区*/
    public static Zone
    groundZero, /** 荒芜沙漠*/desertWastes,
    /**陨石带*/craters, /** 冰冻森林*/frozenForest, /** 遗迹海岸*/ruinousShores, /** 绵延群山*/stainedMountains, /** 油田*/tarFields, /** 真菌通道*/fungalPass,
    /** 盐碱荒滩*/saltFlats, /** 增生区*/overgrowth, /**0078号冲击*/impact0078, /** 悬崖*/crags,
    /**荒芜裂谷*/desolateRift, /** 核列阵*/nuclearComplex,
    /** zones测试战役地图*/
    testZone1
    ;
    ...
    public void load(){
        ...
        // zones add begon
        testZone1 = new Zone("testZone1", new MapGenerator("testZone1", 1)
                .decor(new Decoration(Blocks.snow, Blocks.sporeCluster, 0.02))){{
            loadout = Loadouts.basicShard;
            baseLaunchCost = list(copper, -250);
            startingItems = list(copper, 100);
            conditionWave = 5;
            launchPeriod = 5;
            resources = with(copper, lead, coal);
            requirements = with(
                    new ZoneWave(groundZero, 0)
...
//            baseLaunchCost = list(copper, -60);
        ...
        desertWastes = new Zone("desertWastes", new DesertWastesGenerator(260, 260)){{
            ...
            requirements = with(
            new ZoneWave(groundZero, 20),       // 零号地区 完成20波
            new Unlock(Blocks.combustionGenerator)      // 解锁块 燃烧发电机
            );
        }};
