...
abstract class RPEntity2DView<T extends RPEntity> extends ActiveEntity2DView<T> {
     ...
     */
    private static final Color RING_COLOR_RED = new Color(230 / 255f, 10 / 255f, 10 / 255f, 1);
    private static final Color RING_COLOR_DARK_RED = new Color(74 / 255f, 0, 0, 1);
    private static final Color RING_COLOR_ORANGE = new Color(1, 200 / 255f, 0, 1);
     ...
     */
    private void drawFloaters(final Graphics g2d, final int x, final int y,
                              final int width) {
     ...
     * @param width The drawn width.
     */
    protected void drawHPbar(final Graphics g2d, final int x, final int y,
                             final int width) {
     ...
     * @param width The drawn width.
     */
    protected void drawStatusBar(Graphics g2d, int x, int y, int width) {
        if (showTitle) {
     ...
     * @param width The drawn width.
     */
    protected void drawTitle(final Graphics g2d, final int x, final int y, final int width) {
        if (titleSprite != null) {
     ...
     */
    private void drawCombat(final Graphics g2d, final int x,
...
//        }
     ...
     */
    private void drawArrows(final Graphics g2d, final int x, final int y, final int width, final int height, final EnumSet<Direction> directions, final Color lineColor) {
        if (temp.Debug.TEMP)
            ;
...
//        }
     ...
     * @param light
     */
    private void drawShadedOval(final Graphics g2d, final int x, final int y, final int width, final int height, final Color color, final boolean reversed, final boolean light) {
        if (temp.Debug.TEMP)
            ;
...
//        g2d.drawArc(x, y, width, height, 180, 180);
     ...
     */
    private void drawAttack(final Graphics g2d, final int x, final int y, final int width, final int height) {
        if (isAttacking) {
     ...
     *
     * @param sprite The sprite to manipulate.
     * @return Sprite
     */
...
//        return sprite;
     ...
     */
    @Override
    protected void draw(final Graphics g2d, final int x, final int y,
                        final int width, final int height) {
...
//            g2d.drawRect(x, y, width, height);
            g2d.fillRect(Color.cyan, x, y, width, height);
        }
     ...
     */
    @Override
    protected void drawTop(final Graphics g2d, final int x, final int y,
                           final int width, final int height) {
