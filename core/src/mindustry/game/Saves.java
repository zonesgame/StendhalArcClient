...
import static z.debug.ZDebug.disable_exitSave;
import static z.debug.ZDebug.enable_removeSaves;
...
public class Saves{
    ...
    public SaveSlot addSave(String name){
        if (disable_exitSave) return null;
