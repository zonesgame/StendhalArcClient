...
package arc.ai.sched;

import arc.ai.sched.PriorityScheduler.PrioritySchedulableRecord;
...
public class PriorityScheduler extends SchedulerBase<PrioritySchedulableRecord> {
	 ...
	 * 
	 * @author davebaol */
	static class PrioritySchedulableRecord extends arc.ai.sched.SchedulerBase.SchedulableRecord {
		float priority;
