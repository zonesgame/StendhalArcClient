...
import arc.graphics.g2d.CapStyle;
...
public class ItemBridge extends Block{
    ...
    public boolean acceptItem(Item item, Tile tile, Tile source){
        ...
        if(linkValid(tile, other)){
            ...
            return source.block() instanceof ItemBridge && source.<ItemBridgeEntity>ent().link == tile.pos() && tile.entity.items.total() < itemCapacity[entity.level()];
        }

        return tile.entity.items.total() < itemCapacity[entity.level()];
    }
