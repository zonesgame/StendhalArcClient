 ...
 *
 * @author davebaol */
public class TiledRaycastCollisionDetector<N extends TiledNode<N>> implements RaycastCollisionDetector<Vec2> {
    ...
    @Override
    public boolean collides (Ray<Vec2> ray) {
    ...
    @Override
    public boolean findCollision (Collision<Vec2> outputCollision, Ray<Vec2> inputRay) {
