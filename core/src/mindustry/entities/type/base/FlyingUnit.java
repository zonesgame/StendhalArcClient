...
public class FlyingUnit extends BaseUnit{
    ...
    attack = new UnitState<FlyingUnit>(){
        @Override
        public void enter(FlyingUnit u){
            target = null;
        }

        @Override
        public void update(FlyingUnit u){
    ...
    rally = new UnitState<FlyingUnit>(){
        @Override
        public void update(FlyingUnit u){
            if(retarget()){
    ...
    retreat = new UnitState<FlyingUnit>(){
        @Override
        public void enter(FlyingUnit u){
            target = null;
        }
