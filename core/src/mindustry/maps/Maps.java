...
import mindustry.maps.MapPreviewLoader.MapPreviewParameter;
...
public class Maps{
    /** 内置地图列表.<p/>List of all built-in maps. Filenames only. */
    ...
    /** 加载所有地图.<p/>Load all maps. Should be called at application start. */
    public void load(){
        //defaults; must work
        try{
