...
public abstract class Entity2DView<T extends IEntity> implements EntityView<T> {
     ...
     */
    @Override
    public void draw(final Graphics g2d) {
        applyChanges();
    ...
    private boolean isOnScreen(Graphics g2d, Rectangle r) {
...
//            g2d.drawRect(x, y, width, height);
            g2d.fillRect(Color.blue, x, y, width, height);

//            g2d.setColor(Color.green);
//            g2d.draw(entity.getArea());
            g2d.fillRect(Color.green, entity.getArea());
        }
     ...
     */
    private void drawAttachedSprites(Graphics g2d, int x, int y) {
        Collection<AttachedSprite> sprites = attachedSprites;
        if (sprites != null) {
     ...
     * @param height The drawn entity height.
     */
    protected void drawEntity(final Graphics g2d, final int x, final int y,
                              final int width, final int height) {
     ...
     */
    @Override
    public void drawTop(final Graphics g2d) {
