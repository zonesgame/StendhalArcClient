...
public class Player2DView<T extends Player> extends RPEntity2DView<T> {
     ...
     */
    @Override
    protected void drawStatusBar(final Graphics g2d, final int x, final int y, final int width) {
        /*
...
//        return addShadow(outfit);
     ...
     */
    @Override
    protected void draw(final Graphics g2d, final int x, final int y, final int width, final int height) {
