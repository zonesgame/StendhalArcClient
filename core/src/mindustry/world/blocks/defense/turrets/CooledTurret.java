...
public class CooledTurret extends Turret{
    ...
    public void setStats(){
        ...
        stats.add(BlockStat.booster, new BoosterListValue(reload, consumes[0].<ConsumeLiquidBase>get(ConsumeType.liquid).amount, coolantMultiplier, true, l -> consumes[0].liquidfilters.get(l.id)));
    }
