 ...
 *  qqtx箭塔 物品炮塔块.
 * */
public class ArrowTurretIso extends ItemTurretIso{
    ...
    public ArrowTurretIso(String name){
        super(name);
//        shots = 2;
        // zones add begon
        this.layer = null;
    ...
    public ArrowTurretIso(String name, String configFile){
        this(name);
...
//        Draw.rectGdx(bgRegion, dx, dy, bgRect.width, bgRect.height);
        ...
        region = regions[lev][curVariant][0];
        rect = rects[lev][curVariant][0];
//        dx = pos.x - rect.x;
//        dy = pos.y - rect.y;
