...
import stendhal.StendhalClientLauncher;
...
public class StendhalDesktopLauncher extends StendhalClientLauncher {
    ...
    public static void main(String[] arg){
        try{
            Vars.loadLogger();
            new SdlApplication(new StendhalDesktopLauncher(arg), new SdlConfig(){{
                title = "StendhalClientTest";
//                maximized = true;
                depth = 0;
                stencil = 0;
                width = 1280;
