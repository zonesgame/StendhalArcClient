...
public class Bullets implements ContentList{
    ...
    // 火炮.artillery
    /**高级火炮*/artilleryDense, /**塑料火炮*/artilleryPlastic, /**塑料火炮碎片弹*/artilleryPlasticFrag, /**制导火炮*/artilleryHoming, /**燃烧火炮*/artilleryIncendiary, /**爆炸火炮*/artilleryExplosive, /**火炮单位*/artilleryUnit,

    //高射炮.flak
    /**碎片高射炮*/flakScrap, /**铅高射炮*/flakLead, flakPlastic, /**塑料高射炮*/flakExplosive, /**闪电高射炮*/flakSurge, /**玻璃高射炮*/flakGlass, /**玻璃碎片弹*/glassFrag,

    //导弹.missiles
    /**爆炸导弹*/missileExplosive, /**燃烧导弹*/missileIncendiary, /**波浪导弹*/missileSurge, /**标枪导弹*/missileJavelin, /**蜂群导弹*/missileSwarm, /**亡魂导弹*/missileRevenant,

    //标准.standard
    /**标准铜子弹*/standardCopper, /**标准密集子弹*/standardDense, /**标准钍子弹*/standardThorium, /**标准导航子弹*/standardHoming, /**标准燃烧子弹*/standardIncendiary, /**标准小机甲子弹*/standardMechSmall,
    /**标准燃烧弹*/standardGlaive, /**标准大密度弹*/standardDenseBig, /**标准大钍弹*/standardThoriumBig, /**标准大燃烧弹*/standardIncendiaryBig,

    //电动.electric
    /**(采集激光)长矛激光*/lancerLaser, /**熔炉激光*/meltdownLaser, /**闪电*/lightning, /**###*/arc, /**快速伤害*/damageLightning,

    //流体.liquid
    /**水*/waterShot, /**冷却液*/cryoShot, /**熔渣*/slagShot, /**石油*/oilShot,

    //环境计算.environment, misc.
    /**火球*/fireball, /**基础火焰*/basicFlame, /**化学火焰*/pyraFlame, /**自动闪电*/driverBolt, /**治疗弹药*/healBullet, /**大治疗弹药*/healBulletBig, /**抛物线子弹*/frag, /**红色火焰*/eruptorShot,

    //炸弹.bombs
    /**爆炸炸弹*/bombExplosive, /**燃烧炸弹*/bombIncendiary, /**石油炸弹*/bombOil,
    ...
    public void load(){
        // zones add begon
        testBullet = new BasicBulletType(2.5f, 1 * 18, "bullet"){{
            bulletWidth = 2f;
            bulletHeight = 9f;
            lifetime = 60;
            shootEffect = null;
        ...
        melee1 = new BasicBulletType(enable_isoInput ? 2.5f / (tilesize * 2) : 2.5f, 9, "bullet"){{             // default
            bulletWidth = 7f;
            bulletHeight = 9f;
            lifetime = 60f / 2;
            shootEffect = null;     //  Fx.shootSmall;
            smokeEffect = null;     // Fx.shootSmallSmoke;
            despawnEffect = null;
            hitEffect = null;
//            ammoMultiplier = 2;
        }};
        ...
        artilleryDense = new ArtilleryBulletType(enable_isoInput ? 3f / (tilesize * 4f) : 3f, 0, "shell"){{
            hitEffect = Fx.flakExplosion;
            knockback = enable_isoInput ? 0.8f / (tilesize / 2) : 0.8f;
            lifetime = 50f;
            bulletWidth = bulletHeight = 11f;
            collidesTiles = false;
            splashDamageRadius = enable_isoInput ? 25f / (tilesize) : 25f;
            splashDamage = 33f;
        }};
        ...
        // zones editor
        standardCopper = new BasicBulletType(enable_isoInput ? 2.5f / (tilesize * 5) : 2.5f, 1, "bullet"){{
            bulletWidth = 7f;
            bulletHeight = 9f;
            lifetime = 60f * 1;
            shootEffect = Fx.shootSmall;
...
//        standardCopper = new BasicBulletType(enable_isoInput ? 2.5f / tilesize : 2.5f, 9, "bullet"){{             // default
//            bulletWidth = 7f;
//            bulletHeight = 9f;
//            lifetime = 60f;
//            shootEffect = Fx.shootSmall;
...
//        }};
        ...
        // zones editor
        standardMechSmall = new BasicBulletType(enable_isoInput ? 4f / (tilesize * 20) : 4f, 8, "bullet"){{
            bulletWidth = 11f;
            bulletHeight = 14f;
            lifetime = 40f * 15;
            inaccuracy = 5f;
...
//        standardMechSmall = new BasicBulletType(enable_isoInput ? 4f / tilesize : 4f, 9, "bullet"){{        // default
//            bulletWidth = 11f;
//            bulletHeight = 14f;
//            lifetime = 40f;
//            inaccuracy = 5f;
...
//        damageLightning = new BulletType(0.0001f, 0f){{    // default value
