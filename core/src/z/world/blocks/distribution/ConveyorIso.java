 ...
 *  传送带 块
 * */
public class ConveyorIso extends EditorBlock implements Autotiler{
    /** 物品空间*/
    ...
    protected ConveyorIso(String name){
        super(name);
        rotate = true;
...
//        layer = Layer.overlay;      // default   Layer.overlay
        ...
        entityType = ConveyorIsoEntity::new;
...
//        idleSoundVolume = 0.004f;
    ...
    protected ConveyorIso(String name, String configfile){
        this(name);
...
//        return entity.clogHeat <= 0.5f ;
    ...
    public void onProximityUpdate(Tile tile){
        ...
        int[] bits = buildBlendingRoad(tile, /*tile.rotation()*/0, null, true);
        ConveyorIsoEntity entity = tile.ent();
    ...
    public boolean blends(Tile tile, int rotation, int otherx, int othery, int otherrot, Block otherblock){
        if (enable_isoInput) {
            boolean returnvalue = (otherblock instanceof ConveyorIso || otherblock instanceof RoadBlockIso);
            return returnvalue;
        }
...
//    }
     ...
     *  传送带 瓦砾实体
     * */
    public static class ConveyorIsoEntity extends TileEntity{
        ...
        @Nullable ConveyorIsoEntity nextc;
