...
// *  建造块
// * */
//public class BuildBlockIso extends Block {
//    /***/
//    public static final int maxSize = 9;
//    /***/
//    private static final BuildBlockIso[] buildBlocks = new BuildBlockIso[maxSize];
//
//    /***/
...
//        consumesTap = true;
//        solidifes = true;
//        entityType = BuildEntityIso::new;
//
//        buildBlocks[size - 1] = this;
//    }
//
//    /** 返回建造块尺寸.<p/>Returns a BuildBlock by size. */
//    public static BuildBlockIso get(int size){
...
//        Events.fire(new EventType.BlockBuildEndEvent(tile, playerGroup.getByID(builderID), team, true));
//        tile.remove();
...
//
//        Events.fire(new EventType.BlockBuildEndEvent(tile, playerGroup.getByID(builderID), team, false));
...
//        BuildEntityIso entity = tile.ent();
...
//    }
//
//    public class BuildEntityIso extends TileEntity {
//        /**
//         * The recipe of the block that is being constructed.
//         * If there is no recipe for this block, as is the case with rocks, 'previous' is used.
//         */
//        public @ArcAnnotate.Nullable
//        Block cblock;
//
